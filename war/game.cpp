...
void play() //fully plays a game of war, printing the results of each "Battle"
{
    ...
    while( endgame == false)
    {
        ...
        if(one.usable.cs[one.usable.cs.size()-1].rank > two.usable.cs[two.usable.cs.size()-1].rank) //if P1 wins give the cards to his win pile
        {
            std::cout << "Your card (rank: " << one.usable.cs[one.usable.cs.size()-1].suit << one.usable.cs[one.usable.cs.size()-1].rank << ") beats other card (rank: " << two.usable.cs[two.usable.cs.size()-1].suit << two.usable.cs[two.usable.cs.size()-1].rank << ")" << std::endl;
        ...
        else if(one.usable.cs[one.usable.cs.size()-1].rank < two.usable.cs[two.usable.cs.size()-1].rank)    //if P2 wins the cards go to his pile
        {
            std::cout << "Your card (rank: " << one.usable.cs[one.usable.cs.size()-1].suit << one.usable.cs[one.usable.cs.size()-1].rank << ") loses to other card (rank: " << two.usable.cs[two.usable.cs.size()-1].suit << two.usable.cs[two.usable.cs.size()-1].rank << ")" << std::endl;
        ...
        {
            std::cout << "Your card (rank: " << one.usable.cs[one.usable.cs.size()-1].suit << one.usable.cs[one.usable.cs.size()-1].rank << ") ties with other card (rank: " << two.usable.cs[two.usable.cs.size()-1].suit << two.usable.cs[two.usable.cs.size()-1].rank << ")" << std::endl;
